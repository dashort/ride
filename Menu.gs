...
function createMenu() {
  ...
  ui.createMenu('🏍️ Escort Management')
    ...
    .addSubMenu(ui.createMenu('📧 Email Response Tracking')
      ...
      .addItem('🔄 Reprocess Failed Responses', 'reprocessEmailResponsesWithFixedExtraction')
      .addSeparator()
      .addItem('🧪 Test Request ID Extraction', 'testRequestIdExtraction')
      .addItem('🔍 Verify Response Updates', 'verifyRequestResponseUpdates')
      .addSeparator()
