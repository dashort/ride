...
function dailyHeaderValidation() {
  ...
  try {
    const criticalSheets = [
      { name: 'Requests', headers: ['Request ID', 'Date', 'Submitted By', 'Requester Name', 'Requester Contact', 'Event Date', 'Start Time', 'End Time', 'Pickup', 'Dropoff', 'Second', 'Request Type', 'Riders Needed', 'Escort Fee', 'Status', 'Special Requirements', 'Notes', 'Courtesy', 'Riders Assigned', 'Last Updated'] },
